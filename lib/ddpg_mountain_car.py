...
# ==================================
# Works!
# Was very hard to explore going up hill since penalized.  Tried all sorts of parms for OUP that didn't work
# Adding reward for exploring distance solved the problem
# Adding slight & reasonable params for OUP worked really well
# worked with MEAN as 0, THETA .1 and SIGMA .3
...
def train(sess, env, actor, critic):
    ...
    for i in range(MAX_EPISODES):
        ...
        for j in range(MAX_EP_STEPS):
            ...
            a = actor.predict(np.reshape(s, (actor.a_dim, actor.s_dim)))
