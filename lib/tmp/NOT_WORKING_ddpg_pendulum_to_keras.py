...
# ==================================
# UNSOLVED!!!!!!!!!!!!!!
# TODO switch from tflearn to keras
...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        model = Sequential()
        model.add(Dense(400, input_dim = self.s_dim))
        ...
        model.add(Dense(self.a_dim, activation='tanh'))


        # Scale output to -action_bound to action_bound
        # scaled_out = mp.multiply(out, self.action_bound)
        return model
